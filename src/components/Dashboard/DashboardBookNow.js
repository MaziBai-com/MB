				...
				<div className="headerForm text">
					...
					<div className="row justify-content-center py-2">
							<div class="col-md-10">
								...
								<textarea class="form-control" id="exampleFormControlTextarea1" rows="2" value={booking.text} onChange={handleChange} name='text' placeholder='Any Specific Service'></textarea>
							</div>
			        </div>
					<div className="row justify-content-center py-2">
						<div className="col-md-10 "> 
							<div className="container_service">
									...
									<li class="ks-selected"><input type="checkbox"  onChange={(e)=>{ArrayHandle(e)}} className="bookingsArray" name='services' id="checkboxEleven" value="GARDENER"/><label for="checkboxEleven">GARDENER</label></li>
					...
					<div className="row justify-content-center py-2">
							<div class="col-md-10">
								...
								<textarea class="form-control" id="exampleFormControlTextarea1" rows="2" value={booking.place} onChange={handleChange} name='place'>your address</textarea>
							</div>
			        </div>
